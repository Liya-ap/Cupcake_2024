...
public class BasketController {
    ...
    public static void addRoutes(Javalin app, ConnectionPool connectionPool){
        ...
        app.post("/cupcakesPurchased", ctx -> {
            ...
            displaySuccessfullPurchase(ctx, connectionPool);
        });
    }
     ...
     */
    public static void displayBasketPage(Context ctx, ConnectionPool connectionPool) throws DatabaseException {
     ...
     * @throws DatabaseException Throws exception if database connection/sql fails
     */
    private static void displaySuccessfullPurchase(Context ctx, ConnectionPool connectionPool) throws DatabaseException {
        User currentUser = ctx.sessionAttribute("currentUser");
        ctx.attribute("currentUserEmail", currentUser.getEmail());
     ...
     * @throws DatabaseException Throws exception if database connection/sql fails
     */
    private static int createOrder(ConnectionPool connectionPool, User currentUser) throws DatabaseException {
     ...
     * @throws DatabaseException Throws exception if database connection/sql fails
     */
    private static void createOrdelines(ConnectionPool connectionPool, int orderID, User currentUser) throws DatabaseException {
     ...
     * @throws DatabaseException Throws exception if database connection/sql fails
     */
    public static void listOfCupcakesInBasket(Context ctx, ConnectionPool connectionPool, User currentUser) throws DatabaseException {
